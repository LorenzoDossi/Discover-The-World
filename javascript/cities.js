// three/two places where we want to run our data visualization
// 1. on page load
// 2. on change of first/any select box
// 3. on change of second/any select box
...
const axisYText = svg
    .append("text")
    .attr("class", "y-axis")
    .attr("transform", "translate(35, 360) rotate(-90)")
    .text("y axis")
